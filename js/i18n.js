...
const TRANSLATIONS = {
  zh: {
    ...
    'index.hero.desc':     '以混合重複銷售特徵評估法建構臺灣15個行政區之季度與年度住宅價格指數，2000Q1–2026Q1。資料來源：內政部不動產交易實價登錄。',
    'index.dl.label':      '📥 下載資料：',
    ...
    'index.chart.badge':   '更新至 2026Q1',
    'index.freq.q':        '季',
    'index.freq.a':        '年',
    'index.freq.note':     '基期 = 2000Q1 &nbsp;|&nbsp; 點擊圖例切換城市',
    'index.btn.all':       '全選',
    'index.btn.clear':     '清除',
    'index.chart.note':    '將滑鼠移至任一序列可反白顯示。所有指數以 2000Q1 = 1.00 為基準。數值代表相對於基期的價格水準。',
    'index.chart.yaxis':   '指數 (2000Q1 = 1.00)',
    'index.latest.title':  '最新指數值 — 2026Q1',
    'index.tbl.region':    '地區',
    'index.tbl.index':     '指數 (2026Q1)',
    'index.tbl.qoq':       '季增率',
    'index.tbl.yoy':       '年增率',
    ...
    'comp.note':          '💡 <strong>資料涵蓋：</strong>CL 指數涵蓋至 2026Q1；信義（2026Q1）、國泰（2026Q1）、安富（2026Q1）及官方（2025Q4）指數已更新至最新可取得資料。',
    'comp.dl.label':      '📥 下載：',
    ...
    'comp.corr.title':    '指數間相關係數（重疊期間 2012Q3–2025Q4）',
    ...
    'map.stat.base':      '(2000Q1 = 1.00)',
    'map.stat.qoq':       '季增率',
    'map.stat.yoy':       '年增率',
    'map.stat.risen':     '上漲',
    'map.stat.fallen':    '下跌',
    'map.stat.desc':      '指數顯示自基期（2000Q1）以來價格已',
  ...
  en: {
    ...
    'index.hero.desc':     'Hybrid repeat-sales-hedonic housing price indices for 15 regions of Taiwan, 2000Q1–2026Q1. Based on transaction-level data from the Ministry of Interior.',
    ...
    'index.chart.badge':   'Updated 2026Q1',
    'index.freq.q':        'Quarterly',
    'index.freq.a':        'Annual',
    'index.freq.note':     'Base = 2000Q1 &nbsp;|&nbsp; Click legend to toggle cities',
    'index.btn.all':       'Select All',
    'index.btn.clear':     'Clear',
    'index.chart.note':    'Hover over any series to highlight it. All indices normalized so that 2000Q1 = 1.00. Values represent the price level relative to the base period.',
    'index.chart.yaxis':   'Index (2000Q1 = 1.00)',
    'index.latest.title':  'Latest Index Values — 2026Q1',
    'index.tbl.region':    'Region',
    'index.tbl.index':     'Index (2026Q1)',
    ...
    'comp.note':          '💡 <strong>Data coverage:</strong> CL index runs through 2026Q1. Sinyi (2026Q1), Cathay (2026Q1), AIFE (2026Q1), and Official (2025Q4) indices are updated to the latest available data.',
    ...
    'comp.corr.title':    'Cross-Index Correlation (overlapping period 2012Q3–2025Q4)',
