...
const TRANSLATIONS = {
  zh: {
    ...
    'index.freq.q':        '季',
    'index.freq.a':        '年',
    'index.freq.note':     '基期 = 2001Q1 &nbsp;|&nbsp; 點擊圖例切換城市',
    'index.btn.all':       '全選',
    'index.btn.clear':     '清除',
    'index.chart.note':    '將滑鼠移至任一序列可反白顯示。所有指數以 2001Q1 = 1.00 為基準。數值代表相對於基期的價格水準。',
    'index.chart.yaxis':   '指數 (2001Q1 = 1.00)',
    'index.latest.title':  '最新指數值 — 2025Q4',
    'index.tbl.region':    '地區',
    'index.tbl.index':     '指數 (2025Q4)',
    'index.tbl.qoq':       '季增率',
    'index.tbl.yoy':       '年增率',
    'index.tbl.note':      '基期：2001Q1 = 1.00。季增率 = 季對季；年增率 = 年對年（4季）。',
    'index.footer':        '臺灣住宅價格指數 &nbsp;|&nbsp; 資料來源：內政部實價登錄 &nbsp;|&nbsp; 方法論：CL 重複交易指數',

    /* ── comparison.html ─────────────────────────────────────────── */
    'comp.hero.title':    '臺灣住宅價格指數比較',
    'comp.hero.desc':     'CL 指數與官方（內政部）、信義、國泰及安富指數之比較，所有指數以 2001Q1 = 1.00 為基準。',
    ...
    'comp.chart.title':   '臺灣各住宅價格指數（基期：2001Q1 = 1.00）',
    'comp.chart.note':    '將滑鼠移至序列可查看詳細數值。點擊上方色塊切換指數顯示。',
    'comp.chart.yaxis':   '指數 (2001Q1 = 1.00)',
    ...
    'map.stat.base':      '(2001Q1 = 1.00)',
    'map.stat.qoq':       '季增率',
    'map.stat.yoy':       '年增率',
    'map.stat.risen':     '上漲',
    'map.stat.fallen':    '下跌',
    'map.stat.desc':      '指數顯示自基期（2001Q1）以來價格已',
  ...
  en: {
    ...
    'index.freq.a':        'Annual',
    'index.freq.note':     'Base = 2001Q1 &nbsp;|&nbsp; Click legend to toggle cities',
    'index.btn.all':       'Select All',
    'index.btn.clear':     'Clear',
    'index.chart.note':    'Hover over any series to highlight it. All indices normalized so that 2001Q1 = 1.00. Values represent the price level relative to the base period.',
    'index.chart.yaxis':   'Index (2001Q1 = 1.00)',
    ...
    'index.tbl.note':      'Base period: 2001Q1 = 1.00. QoQ = quarter-on-quarter; YoY = year-on-year (4 quarters).',
    ...
    'comp.hero.desc':     'The CL repeat-sales index plotted alongside the Official (MOI), Sinyi, Cathay, and AIFE indices. All indices normalized to 2001Q1 = 1.00.',
    ...
    'comp.chart.title':   'All Taiwan Housing Price Indices (Base: 2001Q1 = 1.00)',
    'comp.chart.note':    'Hover over series for exact values. Click chips above to toggle indices.',
    'comp.chart.yaxis':   'Index (2001Q1 = 1.00)',
